...
import fimobile.technology.inc.CameraKiosk.DebouncedOnClickListener;
...
//        imgSticker.setOnClickListener(this);
        imgSticker.setOnClickListener(db);
...
//                    file = new File("storage/emulated/0/DCIM/Kiosk/"
//                            file = new File("mnt/usb_storage/USB_DISK0/udisk0/testFolder");
//            file = new File(newString) ;
//                    + File.separator + ""
...
//        mTxtCurrentTool.setText(R.string.camerakiosk_label_sticker);
    ...
    public void onShare()
    {
        ...
        finish(); //ran_edit_101218: added finish()

        // pang sharing ung nalabas sa baba
//        Uri uri = Uri.fromFile(file);
//        Intent intent = new Intent(Intent.ACTION_SEND);
//        intent.setType("image/*");
//        intent.putExtra(Intent.EXTRA_STREAM, uri);
//        EditImageActivity.this.startActivityForResult(Intent.createChooser(intent, "Share Image"), REQUEST_SHARE_IMAGE);
    }
...
//          }
    ...
    private DebouncedOnClickListener db = new DebouncedOnClickListener() {
        @Override
