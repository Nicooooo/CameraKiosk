...
//                USE_SURFACE_ENCODER ? 0 : 1, PREVIEW_WIDTH, PREVIEW_HEIGHT, PREVIEW_MODE);
        ...
        countTextView = (TextView) v.findViewById(R.id.countdown);
        currentImage1 = 2;
        timer = (ImageButton) v.findViewById(R.id.timer);
        timer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                currentImage1++;
                currentImage1 = currentImage1 % images.length;

                timer.setImageResource(images[currentImage1]);
            }
        });
...
//            Toast.makeText(cameraView.getContext(), R.string.picture_taken, Toast.LENGTH_SHORT).show();
            ...
            if(bmp != null){
                ...
                getFragmentManager()
                        ...
                        .replace(
                                R.id.fragment_container,
                                GalleryFragment.newInstance(bmp),
                                GalleryFragment.TAG)
                        .addToBackStack(null)
                        .commit();
            }
