...
public class PhotoEditorView extends RelativeLayout {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.CamerakioskCameraView);
            Drawable imgSrcDrawable = a.getDrawable(R.styleable.CamerakioskCameraView_photo_src);
